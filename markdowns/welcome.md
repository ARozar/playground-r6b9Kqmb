...
@[Try for yourself! Update the code for the 'CalculateCommission' method to pass the test]({"stubs": ["Tuples/Numbers.cs", "Tuples/NumbersTests.cs"],"command": "dotnet.NumbersTests.NumbersTest"})
